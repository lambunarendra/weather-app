...
public class WatchListController {
    ...
    @DeleteMapping("/remove/{cityname}/{userName}/{country}") //add this  
    public void removeCity(@PathVariable String cityname,@PathVariable String userName,@PathVariable String country) throws NoUserFoundException{ // add this ,  
